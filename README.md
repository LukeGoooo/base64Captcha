...
![Test](https://github.com/LukeGoooo/base64Captcha/workflows/Test/badge.svg)
[![Go Report Card](https://goreportcard.com/badge/github.com/LukeGoooo/base64Captcha)](https://goreportcard.com/report/github.com/LukeGoooo/base64Captcha)
[![GoDoc](https://godoc.org/github.com/LukeGoooo/base64Captcha?status.svg)](https://godoc.org/github.com/LukeGoooo/base64Captcha)
...
* [English](https://godoc.org/github.com/LukeGoooo/base64Captcha)
* [中文文档](https://mojotv.cn/go/refactor-base64-captcha)
* [Playground](https://captcha.mojotv.cn)

## 2. 🚀🚀🚀 Quick start
### 2.1 🎬🎬🎬 Use history version
[Tag v1.2.2](https://github.com/LukeGoooo/base64Captcha/tree/v1.2.2)

` go get github.com/LukeGoooo/base64Captcha@v1.2.2`

or edit your `go.mod` file to

`github.com/LukeGoooo/base64Captcha@v1.2.2`

### 2.2 📥📥📥 Download package
    go get -u github.com/LukeGoooo/base64Captcha
